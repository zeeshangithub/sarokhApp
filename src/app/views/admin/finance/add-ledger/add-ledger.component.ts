...
export class AddLedgerComponent implements OnInit {
    ...
    constructor(private formbuilder: FormBuilder, private shipperservice: ShipperService, private addLedgerForService: ShipperService,
    ...
    getAddLedgerFor(ledgerForName) {
        this.addLedgerForService.fetchAddLedgerFor(ledgerForName).subscribe(res => {
            this.addLedgerFor = res.data;
        })
    }
